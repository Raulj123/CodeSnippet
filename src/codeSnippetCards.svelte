...
<script lang="ts">
    import {deleteSnippet, togglefav} from "./snippetStore"
...
<div class="card ">
    ...
    <div class = "float-right">
        <button type="button" class="btn btn-sm variant-filled-secondary {snippet.favorite ? 'btn-favorite' : ''}" on:click={()=>togglefav(index)}>
